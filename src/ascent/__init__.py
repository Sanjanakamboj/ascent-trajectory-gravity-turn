...
maximum payload capability at 400 km / 28.5 deg. Milestone 5 (current) adds direct-
ascent launch-azimuth/inclination geometry (``inclination``) and a payload-vs-
inclination trade across the launch site's full direct-ascent range (28.5-90 deg). No
staging, dogleg, on-orbit plane change, or retrograde-launch trade is implemented yet.
"""
